...
<body style="background-size:100% 100%;height: 100%;width:100%;background-repeat: no-repeat;">
...
<script type="text/javascript">
    ...
    function to(){
        //location.href="<%= request.getContextPath()%>/AutoLogin?method=login&t="+getTimestamp();
        location.href="<%= request.getContextPath()%>/Main?t="+getTimestamp();
    }
